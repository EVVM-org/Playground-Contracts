    ...
    HostChainStationStructs.CrosschainConfig crosschainConfigHost =
        HostChainStationStructs.CrosschainConfig({
            hyperlane: HostChainStationStructs.HyperlaneConfig({
                externalChainStationDomainId: 421614, //Domain ID for External on Hyperlane
                externalChainStationAddress: bytes32(0), //External Chain Station Address on Hyperlane
                mailboxAddress: 0xfFAEF09B3cd11D9b20d1a19bECca54EEC2884766 //Mailbox for Host on Hyperlane
            }),
            layerZero: HostChainStationStructs.LayerZeroConfig({
                externalChainStationEid: 40231, //EID for External on LayerZero
                externalChainStationAddress: bytes32(0), //External Chain Station Address on LayerZero
                endpointAddress: 0x6EDCE65403992e310A62460808c4b910D972f10f //Endpoint for Host on LayerZero
            }),
            axelar: HostChainStationStructs.AxelarConfig({
                externalChainStationChainName: "arbitrum-sepolia", //Chain Name for External on Axelar
                externalChainStationAddress: "", //External Chain Station Address on Axelar
                gasServiceAddress: 0xbE406F0189A0B4cf3A05C286473D23791Dd44Cc6, //Gas Service for External on Axelar
                gatewayAddress: 0xe432150cce91c13a887f7D836923d5597adD8E31 //Gateway for Host on Axelar
            })
        });
    ...
    ExternalChainStationStructs.CrosschainConfig crosschainConfigExternal =
        ExternalChainStationStructs.CrosschainConfig({
            hyperlane: ExternalChainStationStructs.HyperlaneConfig({
                hostChainStationDomainId: 11155111, //Domain ID for Host on Hyperlane
                hostChainStationAddress: bytes32(0), //Host Chain Station Address on Hyperlane
                mailboxAddress: 0x598facE78a4302f11E3de0bee1894Da0b2Cb71F8 //Mailbox for External on Hyperlane
            }),
            layerZero: ExternalChainStationStructs.LayerZeroConfig({
                hostChainStationEid: 40161, //EID for Host on LayerZero
                hostChainStationAddress: bytes32(0), //Host Chain Station Address on LayerZero
                endpointAddress: 0x6EDCE65403992e310A62460808c4b910D972f10f //Endpoint for External on LayerZero
            }),
            axelar: ExternalChainStationStructs.AxelarConfig({
                hostChainStationChainName: "ethereum-sepolia", //Chain Name for Host on Axelar
                hostChainStationAddress: "", //Host Chain Station Address on Axelar
                gasServiceAddress: 0xbE406F0189A0B4cf3A05C286473D23791Dd44Cc6, //Gas Service for External on Axelar
                gatewayAddress: 0xe1cE95479C84e9809269227C7F8524aE051Ae77a //Gateway for External on Axelar
            })
        });
}
