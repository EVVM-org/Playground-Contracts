...
contract fuzzTest_EVVM_pay_noStaker_sync is Test, Constants {
    Staking staking;
    Evvm evvm;
    Estimator estimator;
    ...
    struct PayNoStakerSyncFuzzTestInput_nPF {
        bool useToAddress;
        bool useExecutor;
        bool useNoStaker3;
        address token;
    ...
    struct PayNoStakerSyncFuzzTestInput_PF {
        bool useToAddress;
        bool useExecutor;
        bool useNoStaker3;
        address token;
    ...
    function test__fuzz__pay_noStaker_sync__nPF(
        PayNoStakerSyncFuzzTestInput_nPF memory input
    ) external {
    ...
    function test__fuzz__pay_noStaker_sync__PF(
        PayNoStakerSyncFuzzTestInput_PF memory input
    ) external {
        vm.assume(input.amount > 0);
