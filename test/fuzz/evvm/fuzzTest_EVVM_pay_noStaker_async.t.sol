...
contract fuzzTest_EVVM_pay_noStaker_async is Test, Constants {
    Staking staking;
    Evvm evvm;
    Estimator estimator;
    ...
    struct PayNoStakerAsyncFuzzTestInput_nPF {
        bool useToAddress;
        bool useExecutor;
        bool useNoStaker3;
        address token;
    ...
    struct PayNoStakerAsyncFuzzTestInput_PF {
        bool useToAddress;
        bool useExecutor;
        bool useNoStaker3;
        address token;
    ...
    function test__fuzz__pay_noStaker_async__nPF(
        PayNoStakerAsyncFuzzTestInput_nPF memory input
    ) external {
    ...
    function test__fuzz__pay_noStaker_async__PF(
        PayNoStakerAsyncFuzzTestInput_PF memory input
    ) external {
        vm.assume(input.amount > 0);
