...
contract fuzzTest_EVVM_pay_staker_async is Test, Constants {
    Staking staking;
    Evvm evvm;
    Estimator estimator;
    ...
    struct PayStakerAsyncFuzzTestInput_nPF {
        bool useToAddress;
        bool useExecutor;
        bool useNoStaker3;
        address token;
    ...
    struct PayStakerAsyncFuzzTestInput_PF {
        bool useToAddress;
        bool useExecutor;
        bool useNoStaker3;
        address token;
    ...
    function test__fuzz__pay_staker_async__nPF(
        PayStakerAsyncFuzzTestInput_nPF memory input
    ) external {
    ...
    function test__fuzz__pay_staker_async__PF(
        PayStakerAsyncFuzzTestInput_PF memory input
    ) external {
        vm.assume(input.amount > 0);
